...
const INSTALL_OPTIONS = {
  ...
  "--no-provision": { key: "noProvision", boolean: true },
};
...
Commands:
  install <harness>   Install agent-cortex for a harness
                      ...
                      Options (pi):
                        ...
                        --no-provision        Skip installing the third-party pi packages
                                              declared in the package manifest (e.g.
                                              pi-questions, pi-web-access). They are
                                              installed by default on a real install.
