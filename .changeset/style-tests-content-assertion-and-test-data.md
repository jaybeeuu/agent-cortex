...
plus verification-checklist items. `style-tests/SKILL.md` intentionally grows past the repo's
~100-line convention so the principles load automatically with the skill.
