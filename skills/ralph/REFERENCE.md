...
| File | Purpose |
|------|---------|
| `.agent-cortex/ralph/progress.md` | Human-readable snapshot generated by `pnpm --prefix ~/.copilot/installed-plugins/_direct/agent-cortex/skills/run-beads/scripts exec tsx generate-progress.ts --workspace "$(pwd)"`. **Never hand-edit.** |
