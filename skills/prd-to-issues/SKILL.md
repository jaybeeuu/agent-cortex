...
For each approved slice, create a bead. Use the bead body template below.

Create beads in dependency order (blockers first) so you can reference real bead numbers in the "Blocked by" field.
